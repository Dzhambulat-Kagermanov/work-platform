                ...
                {ratingPositions.map((el, index) => {
                    switch (el) {
                        case "full":
                            return (
                                <li
                                    className={cn(cls.star, [cls.full])}
                                    key={index}
                                >
                                    <Image
                                        src={
                                            "/images/shared/rating/full-star.svg"
                                        }
                                        alt="Полная звезда"
                                        width={18}
                                        height={18}
                        ...
                        case "half":
                            return (
                                <li
                                    className={cn(cls.star, [cls.half])}
                                    key={index}
                                >
                                    <Image
                                        src={
                                            "/images/shared/rating/half-star.svg"
                                        }
                                        alt="Половина звезды"
                                        width={18}
                                        height={18}
                        ...
                        case "empty":
                            return (
                                <li
                                    className={cn(cls.star, [cls.empty])}
                                    key={index}
                                >
                                    <Image
                                        src={
                                            "/images/shared/rating/empty-star.svg"
                                        }
                                        alt="Пустая звезды"
                                        width={18}
                                        height={18}
