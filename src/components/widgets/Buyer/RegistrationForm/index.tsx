...
import { useRegisterSendCodeMutation } from "@/hooks/api/auth";
...
const RegistrationForm: FC<Props> = ({ className }) => {
    const [currentStep, setCurrentStep] = useState<"send" | "verify" | "end">("send");
    ...
    return (
        <Formik 
            ...
            validate={values => {
                const errors: { password?: string, passwordAgain?: string, name?: string } = {}
                if (currentStep === "end") {
                                    ...
                                    /> 
                                    {
                                        !codeSendAgain ? 
                                            ...
                                            >
                                                ...
                                                <Timer second={60} format={undefined} onComplete={() => setCodeSendAgain(true)} /> сек.
                                            </Typography>
                                        : 
                                            <></>
                                    }
