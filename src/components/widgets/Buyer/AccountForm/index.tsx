...
import { cn } from "@/lib";
import { AccountContentBlock, Button, Input, InputMaskSwitcher } from "@/components/ui";
        ...
        >
            <Formik
                ...
                validate={(values) => {
                    ...
                    const errors: Partial<Record<'name' | 'phone' | 'email' | 'password' | 'passwordAgain', string>> = {}
                    ...
                    ({
                        ...
                        <form onSubmit={handleSubmit} className={cn(cls.form)}>
                            ...
                            <div className={cn(cls.btn_wrapper)}>
                                <Button disabled={isSubmitting} type="submit" theme="fill" className={cn(cls.btn_save)}>
                                    Сохранить
                                </Button>
                            </div>
                        </form>
