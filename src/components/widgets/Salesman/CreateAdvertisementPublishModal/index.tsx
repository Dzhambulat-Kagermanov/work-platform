		...
		>
			<div className={cn(cls.content)}>
				...
				<Typography font='Inter-R' size={14} tag='h3'>
					Совет 1: Перейдите в карточку и проверьте корректность данных.
					<br />
					<br />
					Совет 2: Рекламируйте ссылку самостоятельно, если хотите получить
					выкупы быстрее и больше. А мы отразим в статистике сколько покупателей
					пришло с нашей витрины, а сколько купили по прямой ссылке с вашей
					рекламы.
				</Typography>
				<div className={cn(cls.link_wrapper)}>
					...
					<div className={cn(cls.link)}>
						...
						<button className={cn(cls.btn)} onClick={handleCopy}>
							<CopyIcon className={cn(cls.icon)} color='var(--grey-600)' />
						</button>
					</div>
				</div>
				<Button
