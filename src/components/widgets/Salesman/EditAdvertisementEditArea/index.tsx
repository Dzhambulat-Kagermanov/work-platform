		...
		<section className={cn(cls.wrapper, [className])}>
			<div className={cn(cls.item)}>
				...
				<Typography font='Inter-R' size={12}>
					Условия сотрудничества с вами. Их увидят пользователи до того как
					оформят заказ
				</Typography>
			</div>
			<div className={cn(cls.item)}>
				...
				/>
				<Typography font='Inter-R' size={12}>
					Подробная инструкция как найти и выкупить ваш товар. Эта инструкция
					будет отправлена автоматически при создании выкупа.
				</Typography>
			</div>
			<div className={cn(cls.item)}>
				<Textarea
				...
				/>
				<Typography font='Inter-R' size={12}>
					Критерии отзыва, которые покупатель должен соблюсти, когда будет
					составлять отзыв.
				</Typography>
			</div>
		</section>
